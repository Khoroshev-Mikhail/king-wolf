    ...
    return(
        <div className="relative h-screen sm:h-auto min-h-[600px] mb-[70px]">
            ...
            <header className="h-full mt-[20px] sm:mt-0 px-[20px] md:px-[40px] lg:px-[60px] xl:px-[80px] 2xl:px-[200px]">
                ...
                <div className="">
                    <Image priority src={bigwolf_mobile} alt="King wolf" className="absolute z-0 left-0 bottom-[-70px] w-full sm:hidden" loading="lazy"/>
                    <Image priority src={bigwolf} alt="King wolf" className="absolute z-0 top-0 right-0 w-[50%] max-w-[700px] hidden sm:inline-flex " loading="lazy"/> 
                </div>
